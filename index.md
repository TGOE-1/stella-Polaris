...
/*倒三角是目前的正前方（1.28英寸屏幕无倒三角），红点代表正北方向，文字显示正前方和正北方向的夹角*/
...
此处先将显示屏与端子线连接（1.28英寸的屏幕无需连接端子线），注意按照图片中的方向连接。然后连接端子线另一端的八个尖头，以下是引脚连接表与示例图：
...
点击[下载（0.96英寸屏幕代码）](./电子指南针旧.hex)

点击[下载（1.28英寸屏幕代码）](./电子指南针新.hex)

### 开始烧录

(1) 左键双击stc软件，弹框直接点确定。stc软件打开后，将单片机上的转换器插入电脑USB接口。

![stc1](./picture/stc1.png)

(2) 找到stc界面中的单片机型号一栏，在列表中选择STC89C52RC/LE52RC（选择自己单片机的型号，此处仅为展示），软件会自动选择串口号。
