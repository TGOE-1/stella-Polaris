...
本教程旨在教会你完成一个简单的的电子指南针。它通过磁传感器模块实时检测地球磁场并计算方向发送给51单片机，再由51单片机将角度与方位信息画在LED屏幕上。本指南针需要把USB-TTL转换头插在电脑上（或者其他5V电源）供电。

![s1](./picture/show1.jpg)  
/*这是最终成果图，主要元器件包括：51单片机，LED显示屏，磁传感器模块，晶振，USB-TTL转换头*/
